...
| `single-thread-webgpu.wasm` | WebGPU | Memory64 | あり | 必須 | 16 GB | Memory64 + JSPI + WebGPU | active |
| `multi-thread-webgpu.wasm` | WebGPU | Memory64 | あり | 必須 | 16 GB | COOP/COEP + Memory64 + JSPI + WebGPU | active |
